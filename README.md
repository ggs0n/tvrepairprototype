...
Repair Workflow
Order Placed → Searching Technician → Technician Accepted → In Repair → Completed
...
Swagger
Project Structure
tvrepairprototype/ ├── TVRepairPrototype/ # React frontend └── TVRepair.Api/ # ASP.NET Core API
